...
import com.waz.zclient.utils.{BackStackKey, BackStackNavigator, RichView, ViewUtils}
...
class BackupExportView(context: Context, attrs: AttributeSet, style: Int) extends LinearLayout(context, attrs, style) with ViewHelper {
  ...
  private lazy val restoreButton = findById[View](R.id.restore_button)
  ...
  restoreButton.onClick {
    ...
    ViewUtils.showAlertDialog(context,
      R.string.backup_restore_warning_title,
      R.string.backup_restore_warning_content,
      R.string.backup_restore_warning_confirm,
